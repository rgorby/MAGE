...
Building the ``kaiju`` software on the ``cheyenne.ucar.edu`` HPC system
===============================================================================
...
NOTE: In the commands shown below, the shell prompt (the strings starting with ``ewinter@cheyenne4:``\ ) are provided to distinguish commands from their outputs. In your session, your prompt may be different.
...
Building the serial version of the ``kaiju`` software on ``cheyenne.ucar.edu``
--------------------------------------------------------------------------------------
...
.. code-block::
   ...
   #!shell
   ewinter@cheyenne4:~> module purge
   ewinter@cheyenne4:~> module load cmake/3.22.0
   ewinter@cheyenne4:~> module load git/2.33.1  # Needed for git-lfs
   ewinter@cheyenne4:~> module load ncarenv/1.3
   ewinter@cheyenne4:~> module load intel/2022.1
   ewinter@cheyenne4:~> module load geos/3.10.1  # Must come after intel/2022.1
   ewinter@cheyenne4:~> module load ncarcompilers/0.5.0  # Must come after intel/2022.1
   ewinter@cheyenne4:~> module load hdf5/1.12.2
...
.. code-block::
   ...
   #!shell
   ewinter@cheyenne4:~> cd $HOME
   ewinter@cheyenne4:~> mkdir cheyenne
   ewinter@cheyenne4:~> cd cheyenne
...
.. code-block::
   ...
   #!shell
   ewinter@cheyenne4:~/cheyenne> mkdir development
   ewinter@cheyenne4:~/cheyenne> cd development
...
.. code-block::
   ...
   #!shell
   ewinter@cheyenne4:~/cheyenne/development> git clone git@bitbucket.org:aplkaiju/kaiju.git
...
.. code-block::
   ...
   #!shell
   ewinter@cheyenne4:~/cheyenne/development> ls kaiju
...
.. code-block::
   ...
   #!shell
   ewinter@cheyenne4:~/cheyenne/development> cd kaiju
   ewinter@cheyenne4:~/cheyenne/development/kaiju> git switch development
...
.. code-block::
   ...
   #!shell
   ewinter@cheyenne4:~/cheyenne/development/kaiju> mkdir build_serial
   ewinter@cheyenne4:~/cheyenne/development/kaiju> cd build_serial
...
.. code-block::
   ...
   #!shell
   ewinter@cheyenne4:~/cheyenne/development/kaiju/build_serial> date; time FC=`which ifort` cmake -DALLOW_INVALID_COMPILERS=ON .. >& cmake.out; date
...
.. code-block::
   ...
   #!shell
   ewinter@cheyenne4:~/cheyenne/development/kaiju/build_serial> date; time make >& make.out; date
...
.. code-block::
   ...
   #!shell
   ewinter@cheyenne4:~/cheyenne/development/kaiju/build_serial> ls bin
...
Building the MPI version of the ``kaiju`` software on ``cheyenne.ucar.edu``
-----------------------------------------------------------------------------------
...
.. code-block::
   ...
   ewinter@cheyenne4:~> module load geos/3.10.1  # Must come after intel/2022.1
   ewinter@cheyenne4:~> module load ncarcompilers/0.5.0  # Must come after intel/2022.1
   ewinter@cheyenne4:~> module load mpt/2.25
   ewinter@cheyenne4:~> module load hdf5-mpi/1.12.2
...
.. code-block::
   ...
   #!shell
   ewinter@cheyenne4:~/cheyenne/development> cd kaiju
   ewinter@cheyenne4:~/cheyenne/development> git switch development
...
.. code-block::
   ...
   #!shell
   ewinter@cheyenne4:~/cheyenne/development/kaiju> mkdir build_mpi
   ewinter@cheyenne4:~/cheyenne/development/kaiju> cd build_mpi
...
.. code-block::
   ...
   #!shell
   ewinter@cheyenne4:~/cheyenne/development/kaiju/build_mpi> date; time FC=`which ifort` cmake -DENABLE_MPI=ON -DALLOW_INVALID_COMPILERS=ON .. >& cmake.out; date
...
.. code-block::
   ...
   #!shell
   ewinter@cheyenne4:~/cheyenne/development/kaiju/build_mpi> date; time make >& make.out; date
...
.. code-block::
   ...
   #!shell
   ewinter@cheyenne4:~/cheyenne/development/kaiju/build_mpi> ls bin
