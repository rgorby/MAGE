...
`SZIP <https://portal.hdfgroup.org/display/HDF5/Szip+Compression+in+HDF+Products>`_.
Other algorithms are available: zlib (gzip),
...
may load 3rd party filter plugins. To use non-builtin compression filters see
`how to use HDF5 filter plugins <../quickStart/HDF5plugins>`_.
