...
Building the ``kaiju`` software on the ``derecho.hpc.ucar.edu`` HPC system
==================================================================================

Introduction
------------

These instructions will walk you through the process of building and installing the ``kaiju`` software on the ``derecho.hpc.ucar.edu`` supercomputer.
...
In the instructions below, all code will be built and installed in a ``derecho``\ -specific subdirectory of the user home directory, i.e. ``$HOME/derecho``. This particular organization is not required - it is intended as an example of one possible way to segregate software that has been built for the two systems.

Building the serial version of the ``kaiju`` software on ``derecho.hpc.ucar.edu``
-----------------------------------------------------------------------------------------
...
.. code-block::
   ...
   #!shell
   ewinter@derecho4:~> module purge
   ewinter@derecho4:~> module load craype/2.7.20
   ewinter@derecho4:~> module load intel/2023.0.0
   ewinter@derecho4:~> module load geos/3.9.1  # Must come after intel/2023.0.0
   ewinter@derecho4:~> module load ncarcompilers/1.0.0  # Must come after intel/2023.0.0
   ewinter@derecho4:~> module load hdf5/1.12.2
   ewinter@derecho4:~> module load cmake/3.26.3
...
.. code-block::
   ...
   #!shell
   ewinter@derecho4:~> cd $HOME
   ewinter@derecho4:~> mkdir derecho
   ewinter@derecho4:~> cd derecho
...
.. code-block::
   ...
   #!shell
   ewinter@derecho4:~/derecho> mkdir development
   ewinter@derecho4:~/derecho> cd development
...
.. code-block::
   ...
   #!shell
   ewinter@derecho4:~/derecho/development> git clone git@bitbucket.org:aplkaiju/kaiju.git
...
.. code-block::
   ...
   #!shell
   ewinter@derecho4:~/derecho/development> ls kaiju
...
.. code-block::
   ...
   #!shell
   ewinter@derecho4:~/derecho/development> cd kaiju
   ewinter@derecho4:~/derecho/development/kaiju> git switch development
...
.. code-block::
   ...
   #!shell
   ewinter@derecho4:~/derecho/development/kaiju> mkdir build_serial
   ewinter@derecho4:~/derecho/development/kaiju> cd build_serial
...
.. code-block::
   ...
   #!shell
   ewinter@derecho4:~/derecho/development/kaiju/build_serial> date; time FC=`which ifort` cmake -DALLOW_INVALID_COMPILERS=ON .. >& cmake.out; date
...
.. code-block::
   ...
   #!shell
   ewinter@derecho4:~/derecho/development/kaiju/build_serial> date; time make >& make.out; date
...
.. code-block::
   ...
   #!shell
   ewinter@derecho4:~/derecho/development/kaiju/build_serial> ls bin
...
.. code-block::
   ...
   ewinter@derecho4:~> module load geos/3.9.1  # Must come after intel/2023.0.0
   ewinter@derecho4:~> module load ncarcompilers/1.0.0  # Must come after intel/2023.0.0
   ewinter@derecho4:~> module load cray-mpich/8.1.25
   ewinter@derecho4:~> module load hdf5-mpi/1.12.2
...
.. code-block::
   ...
   #!shell
   ewinter@derecho4:~> cd $HOME
   ewinter@cderecho4:~> mkdir derecho
   ewinter@derecho4:~> cd derecho
...
.. code-block::
   ...
   #!shell
   ewinter@derecho4:~/derecho/development> cd kaiju
   ewinter@derecho4:~/derecho/development> git switch development
...
.. code-block::
   ...
   #!shell
   ewinter@derecho4:~/derecho/development/kaiju> mkdir build_mpi
   ewinter@derecho4:~/derecho/development/kaiju> cd build_mpi
...
.. code-block::
   ...
   #!shell
   ewinter@derecho4:~/derecho/development/kaiju/build_mpi> date; time FC=`which ifort` cmake -DENABLE_MPI=ON -DALLOW_INVALID_COMPILERS=ON .. >& cmake.out; date
...
.. code-block::
   ...
   #!shell
   ewinter@derecho4:~/derecho/development/kaiju/build_mpi> date; time make >& make.out; date
...
.. code-block::
   ...
   #!shell
   ewinter@derecho4:~/derecho/development/kaiju/build_mpi> ls bin
