...
This file describes how to set up a python 3.8-based ``conda`` environment on a Ventura Mac which can be used to run the ``kaiju`` code.
...
*A NOTE OF EXPLANATION:* These instructions install ``miniconda3`` into a ventura-specific directory of the home directory, to maintain compatibility with instructions for other systems. Feel free to install ``miniconda3`` wherever is convenient.
...
.. code-block::
   ...
   # Make sure CDF and GEOS have been built and installed.
