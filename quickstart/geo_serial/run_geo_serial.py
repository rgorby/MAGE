...
"""Prepare the PBS script for a bw3d job.

Create the PBS script required to submit a gamera bw3d model to PBS.
"""
...
def create_ini_file():
    ...
    -------
    ini_file : str
        Path to the .ini file for the bw3d model run.
    """
...
def convert_ini_to_xml(ini_file):
    ...
    Convert the .ini file describing the bw3d run to the corresponding
    XML file.
