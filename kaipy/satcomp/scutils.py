...
def read_MJDc(path):
    ...
    format files generated by gamhelio. The MJDC value is the MJD that
    corresponds to the center of the WSA map. This MJD value should be used as
...
def getHelioSatData(scDic:dict, t0:str, t1:str, deltaT:float):
    """Fetch heliospheric spacecraft data in the specified time range.
