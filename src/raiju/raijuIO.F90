module raijuIO
    ...
    ! Precipitation
        ...
        if (Model%doFatOutput) then
            ...
            call AddOutVar(IOVars, "gradPotE"    , State%gradPotE    (is:ie,js:je,:)*1e-3, uStr="kV")
            call AddOutVar(IOVars, "gradPotCorot", State%gradPotCorot(is:ie,js:je,:)*1e-3, uStr="kV")
            call AddOutVar(IOVars, "gradVM"      , State%gradVM      (is:ie,js:je,:)*1e-3, uStr="kV")
