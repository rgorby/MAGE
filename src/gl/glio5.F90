module glio5
    ...
    contains
        ...
        subroutine writeSolution(Model, State, Solution, gStr)
            ...
            call AddOutVar(IOVars,"Jr",Solution%b(:,:,:,XDIR))
            call AddOutVar(IOVars,"Jt",Solution%b(:,:,:,YDIR))
            call AddOutVar(IOVars,"Jp",Solution%b(:,:,:,ZDIR))            
            ...
            call AddOutVar(IOVars,"Jx",SolutionCartesian%b(:,:,:,XDIR))
            call AddOutVar(IOVars,"Jy",SolutionCartesian%b(:,:,:,YDIR))
            call AddOutVar(IOVars,"Jz",SolutionCartesian%b(:,:,:,ZDIR))            
