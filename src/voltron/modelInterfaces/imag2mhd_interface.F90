...
module imag2mhd_interface
    ...
    subroutine CoupleSourceToMhd(vApp)
        ...
        !Use squish x1,x2 to get corner remix potential on gamera grid

        !Use corner potential to get cell-centered Exyz

        !Turn corner x1,x2 into cell-centered lat/lon

        !Fill imag source terms from cell-centered projection
